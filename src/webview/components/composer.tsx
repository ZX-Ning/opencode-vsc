      ...
      <div class="chip-list">
        <For each={props.contextChips}>
          {(chip, index) => (
            <div class="chip">
              <span>
                {chip.type === "file" ? "File" : "Selection"} {chip.path}
                {chip.range ? `#L${chip.range.startLine}-L${chip.range.endLine}` : ""}
              </span>
              <button class="link-button" onClick={() => props.onRemoveChip(index())}>
                ×
              </button>
            </div>
          )}
      ...
      <div class="composer-inner">
        ...
        <div class="composer-toolbar">
          ...
          <Show
            ...
            fallback={
              <button
                class="btn btn-icon btn-primary push-right"
                onClick={handleSend}
